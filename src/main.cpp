            ...
            if (s != "") {
                ...
                if (event == "telemetry") {
                    ...
                    */
                    ...
                    /*********************************************************************************
                     * Draw out the predicted trajectory (Blue)
                     *********************************************************************************/
                    ...
                    int mpc_size = (vars.size()-2)/2;
                    for (int i=2; i< mpc_size+2; i++) {
                        mpc_x_vals.push_back(vars[i]);
                    }
                    for (int i=mpc_size+2; i < vars.size(); i++) {
                    ...
                    /*********************************************************************************
                     * Draw out the waypoints/reference (Green)
                     *********************************************************************************/
